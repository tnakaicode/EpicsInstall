 ...
 *
 * Created from
 *   C:/Users/nakai/epics/base-7.0.2-rc1/modules/libcom/src/env/envDefs.h
 *   C:/Users/nakai/epics/base-7.0.2-rc1/configure/CONFIG_ENV
 *   C:/Users/nakai/epics/base-7.0.2-rc1/configure/CONFIG_SITE_ENV
 */
...
epicsShareDef const ENV_PARAM EPICS_BUILD_TARGET_ARCH =
    {"EPICS_BUILD_TARGET_ARCH", "win32-x86"};
