...
/* Generated from ../O.Common/softIocPVA.dbd */
...
epicsShareExtern reg_func pvar_func_QSRVRegistrar,
    ...
    pvar_func_dlloadRegistar, pvar_func_installPVAAddLinkHook,
    pvar_func_iocshSystemCommand, pvar_func_refTrackRegistrar,
...
int softIocPVA_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* softIocPVA_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"softIocPVA_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    softIocPVA_registerRecordDeviceDriver(*iocshPpdbbase);
}
