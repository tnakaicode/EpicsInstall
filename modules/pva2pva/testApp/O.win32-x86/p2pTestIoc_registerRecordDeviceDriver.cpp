...
/* Generated from ../O.Common/p2pTestIoc.dbd */
...
int p2pTestIoc_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* p2pTestIoc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"p2pTestIoc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    p2pTestIoc_registerRecordDeviceDriver(*iocshPpdbbase);
}
