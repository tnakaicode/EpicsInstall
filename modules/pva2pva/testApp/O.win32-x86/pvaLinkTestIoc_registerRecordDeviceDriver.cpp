...
/* Generated from ../O.Common/pvaLinkTestIoc.dbd */
...
epicsShareExtern reg_func pvar_func_QSRVRegistrar,
    ...
    pvar_func_installPVAAddLinkHook, pvar_func_rsrvRegistrar,
...
int pvaLinkTestIoc_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* pvaLinkTestIoc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"pvaLinkTestIoc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    pvaLinkTestIoc_registerRecordDeviceDriver(*iocshPpdbbase);
}
